...
export default function Sidebar() {
    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="p-5 border-b border-slate-200">
        <Link href="/" className="flex items-center space-x-3 group">
          <div className="w-10 h-10 rounded-xl bg-[#003366] flex items-center justify-center text-white shadow-sm shrink-0 group-hover:scale-105 transition">
        ...
        <button
          ...
          className="mt-4 w-full flex items-center justify-between bg-slate-50 hover:bg-slate-100 border border-slate-200 px-3 py-2 rounded-lg text-xs text-slate-600 transition shadow-2xs group"
        >
      ...
      <div className="flex-1 overflow-y-auto px-3.5 py-4 space-y-6">
        ...
        {/* Regulatory Hierarchy Card */}
        <div className="mx-1 p-3 rounded-xl bg-slate-50 border border-slate-200 text-xs space-y-2">
          <div className="flex items-center space-x-1.5 font-bold text-slate-800 text-[11px]">
            <ShieldCheck className="w-3.5 h-3.5 text-blue-600" />
            <span>Hierarki Peraturan BI</span>
          </div>
          <div className="space-y-1 text-[11px] text-slate-600 font-mono">
            <div className="flex items-center space-x-1.5">
              <span className="w-4 h-4 rounded bg-blue-100 text-blue-800 flex items-center justify-center font-bold text-[9px]">1</span>
              <span>PBI (Peraturan BI)</span>
            </div>
            <div className="flex items-center space-x-1.5">
              <span className="w-4 h-4 rounded bg-teal-100 text-teal-800 flex items-center justify-center font-bold text-[9px]">2</span>
              <span>PADG (Dewan Gubernur)</span>
            </div>
            <div className="flex items-center space-x-1.5">
              <span className="w-4 h-4 rounded bg-indigo-100 text-indigo-800 flex items-center justify-center font-bold text-[9px]">3</span>
              <span>PADG Intern BI</span>
            </div>
            <div className="flex items-center space-x-1.5">
              <span className="w-4 h-4 rounded bg-amber-100 text-amber-800 flex items-center justify-center font-bold text-[9px]">4</span>
          ...
          <div className="pt-1 border-t border-slate-200">
            ...
            >
              <span>Portal jdih.bi.go.id</span>
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 z-40 border-r border-slate-200 bg-white shadow-2xs">
        {sidebarContent}
      </aside>
